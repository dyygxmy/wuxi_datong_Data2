...
#include "source/dataprocessor.h"
...
static const char qt_meta_stringdata_DataProcessor[] = {
    "DataProcessor\0\0opCode,frame\0"
    "controlFrameReceived(WebSocketProtocol::OpCode,QByteArray)\0"
    "frame,lastFrame\0textFrameReceived(QString,bool)\0"
    "binaryFrameReceived(QByteArray,bool)\0"
    "message\0textMessageReceived(QString)\0"
    "binaryMessageReceived(QByteArray)\0"
    "code,description\0"
    "errorEncountered(WebSocketProtocol::CloseCode,QString)\0"
    "pSocket\0process(QTcpSocket*)\0clear()\0"
};
